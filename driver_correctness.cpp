...
#elif defined ONE_LOCK_BLOCKING_QUEUE
#include "queues/one_lock_blocking_queue.h"
OneLockBlockingQueue<int> my_queue;
...
std::atomic<bool> no_more_enqueues;
...
int main(int argc, char *argv[])
{
    ...
    options.add_options("custom", {
                                      ...
                                      {"inputFile", "Input file path for random numbers file", cxxopts::value<std::string>()->default_value("inputs/rand_5000")},
                                  });
